...
class TorchApproximator(Serializable):
    ...
    def __init__(self, input_shape, output_shape, network, optimizer=None,
                 ...
                 reinitialize=False, dropout=False, quiet=True, clip_gradient=None, **params):
        """
        Constructor.
        ...
        Args:
            ...
            clip_gradient (optional float): clip gradient before backpropagation
    ...
    def _fit_batch(self, batch, use_weights, kwargs):
        ...
        if self._clip_gradient is not None:
            for param in self.network.parameters():
                param.grad.data.clamp_(-self._clip_gradient, self._clip_gradient)
